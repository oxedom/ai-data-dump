...
=======
    - create your file under `thoughts/shared/handoffs/issue-XXXX/YYYY-MM-DD_HH-MM-SS_issue-ZZZZ_description.md`, where:
        - YYYY-MM-DD is today's date
        - HH-MM-SS is the hours, minutes and seconds based on the current time, in 24-hour format (i.e. use `13:00` for `1:00 pm`)
        - issue-XXXX is the issue number (replace with `general` if no issue)
        - issue-ZZZZ is the issue number (omit if no issue)
        - description is a brief kebab-case description
    - Run metadata generation script if available
    - Examples:
        - With issue: `2025-01-08_13-55-22_issue-2166_create-context-compaction.md`
...
=======
# Handoff: #XXXX {very concise description}
>>>>>>> 2930c7d3eaa26282002bc45cbeb4f5a5739820ee
...
=======
### 3. Save the Document
Save the handoff document to the specified location.
>>>>>>> 2930c7d3eaa26282002bc45cbeb4f5a5739820ee
...
=======
/resume_handoff thoughts/shared/handoffs/issue-2166/2025-01-08_13-44-55_issue-2166_create-context-compaction.md
>>>>>>> 2930c7d3eaa26282002bc45cbeb4f5a5739820ee
```
</example_response>
